 ...
 */
public class BuyFragment extends Fragment implements SearchView.OnQueryTextListener {
    IpAddress ip;
    Context ctx;
    String searchhint[];
    ...
    RecyclerView rv;
    DataAdapter2 dataAdapter2, adapter2;
    List<GetSet> data;
    android.support.v7.widget.SearchView searchView;
    private List<GetSet> mCountryModel;
    public BuyFragment() {
    ...
    public boolean onQueryTextChange(String newText) {
        ...
        dataAdapter2 = new  DataAdapter2( iconTextTabsActivity,filteredModelList);
        dataAdapter2.notifyDataSetChanged();
        rv.setAdapter(dataAdapter2);
    ...
    private class AsyncFetch1 extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            try {
                ...
                url = new URL(ipurl+"alldata_sell.php");
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                for (int i = 0; i < jArray.length(); i++) {
                    ...
                    //   getSet.selectedPermissionsRadio=json_data.getString("selectedPermissionsRadio");
                    ...
                    Log.d("TAG", "Server result" + "" + json_data.getString("top") + "" + json_data.getString("topr") + "" + json_data.getString("paddress") +
                            ...
                            + "" + json_data.getString("pownername") + "" + "image" + json_data.getString("imagepath"));
                    data.add(getSet);

                }
                rv = getView().findViewById(R.id.rv_recycler_view);
                dataAdapter2 = new DataAdapter2(iconTextTabsActivity, data);
                rv.setAdapter(dataAdapter2);
