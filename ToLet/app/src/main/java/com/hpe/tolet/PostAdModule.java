...
public class PostAdModule extends AppCompatActivity {
    Button b6, b7, b8, b9;
    EditText et12, et13, et15, et16, et17, et18;
    RadioButton flat, pg, hostel, otherr, roomatesAllowed, roomatesNotAllowed, owner, potenialTeanant;
    ImageButton im;
    LinearLayout ll;
    String typeofproperty="Rent", selectedProertyTypeRadio, selectedPermissionsRadio, selectedPosterRadio, pnoofpersons, pownername, pphoneno, pdetails, ppricerange,
            paddress;
    ImageView iv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_post_ad_module);
        ...
        et16.setText("8127442587");
        et17 = findViewById(R.id.editText17);
        et17.setText("dharmendr");
      //  et18 = findViewById(R.id.editText18);
        ...
        roomatesAllowed = findViewById(R.id.radioButton9);
        roomatesNotAllowed = findViewById(R.id.radioButton10);

      //  owner = findViewById(R.id.radioButton11);
      //  potenialTeanant = findViewById(R.id.radioButton12);
    ...
    public void submitPostAds(View v){
...
else if (selectedProertyTypeRadio==null)
{
    Toast.makeText(this, "Select property Type", Toast.LENGTH_SHORT).show();
        ...
        if (roomatesAllowed.isChecked()) {
            selectedPermissionsRadio = roomatesAllowed.getText().toString().trim();
        }
        if (roomatesNotAllowed.isChecked()) {
            selectedPermissionsRadio = roomatesNotAllowed.getText().toString().trim();
        }


       else if (selectedPermissionsRadio==null)
        {
            Toast.makeText(this, "Select roomamtes", Toast.LENGTH_SHORT).show();
        }
        else if (encodedImage==null)
        {
            ...
            //   pnoofpersons = et18.getText().toString().trim();
    ...
    /*    Toast.makeText(this, "type" + typeofproperty + "1property" + selectedProertyTypeRadio +
                ...
                "persons" + pnoofpersons + "8postingas" + selectedPosterRadio+"image::::", Toast.LENGTH_LONG).show();
...
*/
            ...
            if (isOnline()) {
                ...
                Log.d("ad", "type" + typeofproperty + "1property" + selectedProertyTypeRadio +
                        "2address" + paddress + "3price" + ppricerange + "4details" + pdetails +
                        "5phone" + pphoneno + "6owner" + pownername + "7permissions" + selectedPermissionsRadio +
                        "image::::");

                BackgroundTaskPostAd backgroundTaskPostAd = new BackgroundTaskPostAd(this);
                backgroundTaskPostAd.execute(method, typeofproperty, selectedProertyTypeRadio, paddress, ppricerange,
                        pdetails, pphoneno, pownername, selectedPermissionsRadio, encodedImage);
            ...
            if (requestCode == 0) {
                switch (resultCode) {
                    case Activity.RESULT_OK:
                        ...
                        Toast.makeText(PostAdModule.this, "ImageSet", Toast.LENGTH_SHORT).show();
                        ...
                        Toast.makeText(PostAdModule.this, "Wait for moment ....", Toast.LENGTH_SHORT).show();
                        break;
