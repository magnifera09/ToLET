...
public class DataAdapterWish extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public DataAdapterWish(Context context, List<GetSet> data) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.container_fishwish, parent, false);
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, int position) {
      ...
      final   GetSet   current = data.get(position);
        ...
        //click event
        ((MyHolder) holder).rv.setOnClickListener(new View.OnClickListener() {
            @Override
