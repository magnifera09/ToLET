...
public class DataAdapter2 extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public DataAdapter2(Context context, List<GetSet> data){
...
String dir="Mypp";
     ...
     //   myHolder.roommates.setText("Roommates: "+current.selectedPermissionsRadio);
        ...
        Picasso.with(holder.itemView.getContext()).load(current.getImagepath1())
                ...
                .into(myHolder.iv);
   //click
        myHolder.roommates.setVisibility(View.INVISIBLE);
...
//
        ...
        ((DataAdapter2.MyHolder) holder).wishButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ((DataAdapter2.MyHolder) holder).wishButton.setVisibility(View.INVISIBLE);
                ((DataAdapter2.MyHolder) holder).wishButton2.setVisibility(View.VISIBLE);
...
Log.d("Tag","wish"+ current.getPownername() +""+ current.getPphoneno() +""+ current.getPaddress() +"image"+ current.getImagepath1());
    ...
    class MyHolder extends RecyclerView.ViewHolder {
        ...
        ImageButton imageButton,wishButton,wishButton2;
        RelativeLayout rv;
        List<GetSet> data= Collections.emptyList();
        // create constructor to get widget reference
        public MyHolder(View itemView,List<GetSet> data) {
            super(itemView);
